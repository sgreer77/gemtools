...
**bedpe2window:** Generate windows around SV breakpoints for SV analysis
	...
	gemtools2 -T bedpe2window -i [LR_input.bedpe] -w [window_size] -o [out.bedpe]
	
	Ex: gemtools2 -T bedpe2window -i large_sv_calls.bedpe -w 5000 -o large_sv_calls.wndw.bedpe
...
**get_shared_bcs:** Determine barcodes shared between SV breakpoints
	...
	gemtools2 -T get_shared_bcs -i [out.bedpe] -b [LR_bam_file] -o [out.shared]
	
	Ex: gemtools2 -T get_shared_bcs -i large_sv_calls.wndw.bedpe -b phased_possorted.bam -o out.shared.txt
...
**assign_sv_haps:** Assign SV barcodes to existing haplotypes (SNVs)
	...
	Ex: gemtools2 -T assign_sv_haps -i out.shared.txt -c phased_variants.vcf.gz -t phased_variants.vcf.gz -o out.haps.txt
...
**count_bcs:** Determine presence and quantity of given barcodes across a given region surrounding the SV breakpoints
	...
	Ex: gemtools2 -T count_bcs -i out.shared.txt -b phased_possorted.bam -x 1000 -y 50000 -s call_110 -q shared -o out.bc_count.txt 
